...
public class StreamExecTemporalJoin extends ExecNodeBase<RowData>
    ...
    private TwoInputStreamOperator<RowData, RowData, RowData> createJoinOperator(
        ...
        if (rightTimeAttributeIndex >= 0) {
            ...
            // temporal table
            //                // join.
            //                // However, the semantic of this implementation is problematic,
            // because the join
            //                // processing
            //                // for left stream doesn't wait for the complete snapshot of temporal
            // table, this
            //                // may
            //                // mislead users in production environment. See FLINK-19830 for more
            // details.
