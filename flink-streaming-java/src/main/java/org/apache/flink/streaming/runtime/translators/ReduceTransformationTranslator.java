...
public class ReduceTransformationTranslator<IN, KEY>
    ...
    public Collection<Integer> translateForStreamingInternal(
        ...
        if (keySelector != null && StreamExecutionUtils.isCheckpointDisableDuringBacklog(context)) {
            StreamExecutionUtils.applyBacklogProcessingSettings(transformation, context, node);
        }
        return ids;
    }
}
