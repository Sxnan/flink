...
import static org.apache.flink.streaming.runtime.translators.BatchExecutionUtils.deriveMemoryWeight;

/** A utility class for applying sorting inputs during backlog processing. */
public class StreamExecutionUtils {
    static boolean isCheckpointDisableDuringBacklog(TransformationTranslator.Context context) {
    ...
    static void applyBacklogProcessingSettings(
