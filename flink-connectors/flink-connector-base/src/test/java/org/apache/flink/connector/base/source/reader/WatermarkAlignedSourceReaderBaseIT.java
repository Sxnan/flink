...
public class WatermarkAlignedSourceReaderBaseIT {
	...
	public void testWatermarkAlignedSource() throws Exception {
		...
		env.fromSource(source, WatermarkStrategy.forGenerator((context) -> new TestWatermarkGenerator()), "TestingSource")
	...
	static class WatermarkAlignmentTestSource implements Source<Integer, MockSourceSplit, List<MockSourceSplit>> {
		...
		createEnumerator(SplitEnumeratorContext<MockSourceSplit> enumContext) {
			return new MockSplitEnumerator(
				getSplits(),
				enumContext, 100);
		}
	...
	static class MockSplitEnumerator extends WatermarkAlignedSplitEnumerator<MockSourceSplit, List<MockSourceSplit>> {
