 ...
 * concurrently, which support watermark alignment at the same time.
 */
public class WatermarkAlignedSingleThreadFetcherManager<E, SplitT extends SourceSplit>
        extends WatermarkAlignedSplitFetcherManager<E, SplitT> {
     ...
     */
    public WatermarkAlignedSingleThreadFetcherManager(
